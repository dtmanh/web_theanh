...
|
*/
//$config['encryption_key'] = 'tech_2019';
...
$config['from_mail']        = '';
$config['from_u']        = '[TECH tology 4.0]';
$config['smtp_host']        = 'smtp.gmail.com';//smtp.gmail.com
$config['smtp_hostssl']     =  'ssl://smtp.googlemail.com' ;
$config['smtp_user']        = 'website.wintech4.0@gmail.com';//'trantrung129@vnnetsoft.com' ;//
$config['smtp_pass']        = 'bjohuxxcpefnftza'; //'trungtrung129@@';//

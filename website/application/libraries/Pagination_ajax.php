    ...
    class Pagination_ajax{
        function create($total, $number_per_page, $current_page = 1, $class='paginate_button', $classCurrent = 'paginate_active'){
            ...
            if($last_page > 1){
                ...
                $pagination_system .= '<select class="paginate_length hidden"  id="paginate_length"  onchange="doiphantrang()" style="width:45px;">';
                ...
                $pagination_system.= '<ul class="pagination phantrang-home">';
                // Trang trước
                if($current_page > 1){
                ...
                if ($last_page < 7 + ($pagination_stages * 2)){
                    ...
                    for ($page_counter = 1; $page_counter <= $last_page; $page_counter++){
                        if ($page_counter == $current_page) {
                            $pagination_system.= "<li class=\"active\"><a class='paginate_active'>$page_counter</a></li>";
                        }else {

...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('techadmin/comment/comments')?>">Danh sách bình luận</a></li>
	...
	<div class="row">
        <div class="col-md-12">
          <div class="box box-body">
            <div class="col-md-6">
              <h4><i class="fa fa-list"></i> &nbsp;  Danh sách bình luận</h4>
            </div>
    ...
    <!-- Page Heading -->
	 <div class="box">
		...
		<div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('techadmin/comment/deletes')?>">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="<?= base_url('techadmin/comment/delete/'.$v->id)?>"

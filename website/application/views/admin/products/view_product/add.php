...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?= base_url('techadmin/product/products')?>">Danh sách tin rao</a></li>
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  ...
                  <ul class="nav nav-tabs">
                     ...
                     <li class="hidden"><a data-toggle="tab" href="#menu2">Thuộc tính phụ</a></li>
                     <li><a data-toggle="tab" href="#menu4">Up ảnh</a></li>
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                 <div class=" checklist_cate cat_checklist" style="border: 1px solid #ccc;padding: 5px">
                                    <?php if (isset($size_selected)) $size_selected = $size_selected;
                                    else $size_selected = null;
                                    view_size_cate_checklist($sizes, 0, '', @$size_selected)?>
                                 </div>
                              </div>
      ...
      <div class="col-md-3" style="font-size: 12px">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <div class="col-sm-12" id="view_img">
                  <?php  if(!empty($edit->image)){ ?>
                  <img src="<?=base_url('upload/img/products/'.$edit->pro_dir .'/thumb/'.$edit->image)?>" id="image_review" width="100%">
...
type: "POST",
dataType: "json",
url: '<?php echo base_url('admin/product/deleteprofaq')?>',
data: {id:id},

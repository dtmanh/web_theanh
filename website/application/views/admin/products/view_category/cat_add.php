...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('techadmin/product/categories')?>">Danh sách danh mục sản phẩm</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<ul class="nav nav-tabs">
							...
							<li class=""><a data-toggle="tab" href="#menu4">up ảnh</a></li>
			...
			<div class="col-md-3" style="font-size: 12px">
                <div class="panel panel-default">
                    ...
                    <div class="form-group hidden">
                            <label class="col-sm-12 ">Hình ảnh banner</label>
                            <div class="col-sm-12">
							...
							<div class="col-sm-12">
								<?php
								if(!empty($edit->banner)){ ?>
									<img src="<?=base_url(''.$edit->banner)?>" id="view_fill" width="100%">
									<label class="col-sm-12 "></label>
									<button  type="button" onclick="delete_fillter($(this))" data-value="banner" data-placement="product_category" class="btn btn-success btn-xs"><i class="fa fa-times"></i> Xóa ảnh</button>
								<?php }else{

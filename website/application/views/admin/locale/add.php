...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('techadmin/attribute/listLocale')?>">Danh sách trình độ</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <label  class="col-sm-12">Tên trình độ học vấn</label>

                            <div class="col-sm-12">

								<input type="text" oninput="createAlias(this)" class="form-control input-sm validate[required]" name="name"

                                    value="<?=@$edit->name;?>" placeholder="Tên trình độ học vấn"/>
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
                         ...
                         <div class="form-group hidden">
  							...
  							<label class="col-sm-12"><?=@$show_listBrand->name?>:</label>
  							...
  							<div class="col-sm-12">
  								...
  								<div class="clearfix" style="border: 1px solid #ccc;padding: 5px">
  									...
  									<div class=" checklist_cate cat_checklist">
  										...
  										view_product_brand_checklist($procat, 0, '', @$cate_selected)?>

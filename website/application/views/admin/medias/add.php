				...
				<div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#menu1">Ảnh</a></li>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<div class=" checklist_cate cat_checklist" style="border: 1px solid #ccc; padding: 5px;list-style: none;" >
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <label class="col-sm-12 ">file load</label>
							...
							<div class="col-sm-12" id="view_img">
								...
								if(file_exists(@$edit->link)){ ?>
									...
									<img src="<?=base_url()?>assets/img/specification-25.png" id="image_review" style="max-width: 100%;" >

									<label class="col-sm-12 "></label>
									<br>

									<button  type="button" onclick="delete_fillter($(this))" data-value="link" data-placement="media" class="btn btn-success btn-xs"><i class="fa fa-times"></i> Xóa file</button>

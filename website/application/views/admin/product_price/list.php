...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('techadmin/attribute/listprice')?>">Danh sách mức lương</a></li>
...
<section class="content">
	<div class="row">
        <div class="col-md-12">
          <div class="box box-body">
            <div class="col-md-6">
              <h4><i class="fa fa-list"></i> &nbsp;  Danh sách mức lương</h4>
            </div>
            <div class="col-md-6 text-right">
              <div class="btn-group margin-bottom-20"> 
                <a href="<?= base_url('techadmin/attribute/addprice')?>" class="btn btn-success">
    ...
    <div class="box">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('techadmin/attribute/deletes_price_category')?>">
                ...
                <table id="example" class="table table-bordered table-striped">
					...
					<thead>
                        ...
                        <tr>
							...
							<th width="">Tên mức lương</th>

							<th class="hidden" width="">Danh mục thuộc tính phụ</th>

							<th width="20%" class="no-sort hidden">giá từ</th>

							<th width="20%" class="no-sort hidden">đến giá	</th>
					 ...
					 <?php if (isset($list)) {
						...
						<tr>
							...
							<td class="hidden"><?= number_format(@$v->from_price) ?></td>
                ...
                <?= number_format(@$v->to_price) ?>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('techadmin/attribute/editprice/' . $v->id) ?>"><i

										class="fa fa-pencil"></i> </a>

								<a class="btn btn-xs btn-danger"

								   href="<?= base_url('techadmin/attribute/deletepricecategory/' . $v->id) ?>" title="Xóa"
